...
#pragma region "object_initialization"
    ...
    // (note we set these higher than 1 that together with GL_REPEAT 
...
*************************************************************************/
GLuint DiscardFrag::loadTexture(GLchar* path, GLboolean alpha/* = false*/)
{
...
void DiscardFrag::key_callback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
...
void DiscardFrag::mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
    if (firstMouse) {
        lastX = xpos;
        lastY = ypos;
...
void DiscardFrag::scroll_callback(GLFWwindow* window, double xoffset, double yoffset)
{
    camera.ProcessMouseScroll(yoffset);
}

void DiscardFrag::do_movement()
{
    // Camera controls
    if (keys[GLFW_KEY_W])
